...
<body id="inner_page">
  ...
  <section class="inner">
    ...
    <section class="contents" id="contents">
      <h2 class="bbb">やまなしアプロー地</h2>
      <ul>
        <li class=""><img src="/assets/img/works/web/18/01.png" alt="" /></li>
        <li class=""><img src="/assets/img/works/web/18/02.png" alt="" /></li>
      </ul>
      <div class="text-section">
        <p class="info bbb-mini">やまなしアプロー地</p>
